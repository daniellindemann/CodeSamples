...
angular
	...
	.config(['$routeProvider', function ($routeProvider) {
	    $routeProvider
			.when('/1', {
			    ...
			    templateUrl: Basta.Url.serverRelativeSiteUrl + '/Style Library/basta03/js/nameView.html'
			})
			.when('/2', {
			    controller: 'SampleWizardCtrl',
			    templateUrl: Basta.Url.serverRelativeSiteUrl + '/Style Library/basta03/js/questionsView.html'
			})
			.when('/3', {
			    controller: 'SampleWizardCtrl',
			    templateUrl: Basta.Url.serverRelativeSiteUrl + '/Style Library/basta03/js/summeryView.html'
			})
			.otherwise({
			    redirectTo: '/1'
			});
	...
	.factory('sampleFactory', ['$document', '$q', '$http', function ($document, $q, $http) {
	    ...
	    factory.saveToList = function (data) {
	        // consts
	        var listId = '7C2AA517-9180-4CED-8BF0-AEF359B9FA8C';
...
// bootstrap the app
angular.bootstrap($basta.$('#sampleWizard')[0], ['sampleWizard']);
